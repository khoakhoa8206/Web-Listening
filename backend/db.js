...
export async function initDb() {
  ...
  // Cache transcript BỀN VỮNG (khác với cache tạm trong bộ nhớ ở youtube.js):
  // dùng để lưu transcript đã lấy được từ máy cá nhân (IP nhà, không bị YouTube chặn)
  // rồi đẩy lên qua route /api/videos/cache-transcript, để backend trên Render
  // (IP bị chặn) không cần tự gọi YouTube nữa mà đọc thẳng từ đây.
  await pool.query(`
